...
def downtoearth(url, depth, CITY_LIST):
                ...
                for return_url in returned_url_list:
                    ...
                    if link and link != URL:
                        ...
                        if 'http' not in link:
                            ...
                            downtoearth(link, depth-1, CITY_LIST)
...
def DowntoearthNewsSiteCrawler(url, depth, CITY_LIST):
    ...
    if pgsrc:
        ...
        for tag in a_tags:
            ...
            downtoearth(link, depth, CITY_LIST)
    else:
        print("can't read")
...
if __name__ == '__main__':
    ...
    downtoearth('https://www.downtoearth.org.in', 5, CITY_LIST)
