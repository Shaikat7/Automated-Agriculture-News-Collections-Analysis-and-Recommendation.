...
def krishijagan(url, depth, CITY_LIST):
                ...
                for return_url in returned_url_list:
                    ...
                    if link and link != URL:
                        ...
                        if 'http' not in link:
                            ...
                            krishijagan(link, depth-1, CITY_LIST)
...
def KrishiJaganNewsSiteCrawler(url, depth, CITY_LIST):
    ...
    if pgsrc:
        ...
        for tag in a_tags:
            ...
            krishijagan(link, depth, CITY_LIST)
    else:
        print("can't read")
...
if __name__ == '__main__':
    ...
    krishijagan('https://krishijagran.com/news', 5, CITY_LIST)
