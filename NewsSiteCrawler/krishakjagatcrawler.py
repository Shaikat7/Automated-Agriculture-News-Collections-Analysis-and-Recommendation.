...
# TOTAL_TIME = 23*60*60
# TOTAL_TIME = 1*1*60
URL = "https://www.en.krishakjagat.org/"
...
def krishakjagat(url, depth, CITY_LIST):
            ...
            if pgsrc:
                ...
                if tag and tag.get('content') == 'article':
                    ...
                    try:
                        ...
                        article.download()
                        article.parse()
                        location = 'Mumbai' #this is not location ...just to fillup this I put mumbai
                ...
                for return_url in returned_url_list:
                    ...
                    if link and link != URL:
                        ...
                        if 'http' not in link:
                            ...
                            krishakjagat(link, depth-1, CITY_LIST)

                        elif 'agriculture' in link:
                            # addition of all the urls present in this web page
                            # if any(item in link for item in CITY_LIST):
                            krishakjagat(link, depth-1, CITY_LIST)
                    else:
...
def KrishakJagatNewsSiteCrawler(url, depth, CITY_LIST):
    ...
    if pgsrc:
        ...
        for tag in a_tags:
            ...
            krishakjagat(link, depth, CITY_LIST)
    else:
        print("can't read")
...
if __name__ == '__main__':
    ...
    krishakjagat('https://www.en.krishakjagat.org/', 5, CITY_LIST)
