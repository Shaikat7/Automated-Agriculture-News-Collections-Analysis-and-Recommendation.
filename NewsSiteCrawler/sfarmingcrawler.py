...
def sfarming(url, depth, CITY_LIST):
                ...
                for return_url in returned_url_list:
                    ...
                    if link and link != URL:
                        ...
                        if 'http' not in link:
                            ...
                            sfarming(link, depth-1, CITY_LIST)
...
def SfarmingNewsSiteCrawler(url, depth, CITY_LIST):
...
if __name__ == '__main__':
    ...
    sfarming('https://www.agriculture.com/technology', 5, CITY_LIST)
